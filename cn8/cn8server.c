...
/*OUTPUT
(base) [dr.d01@fedora cn8]$ gedit cn8server.c
(base) [dr.d01@fedora cn8]$ getit cn8client.c
bash: getit: command not found...
(base) [dr.d01@fedora cn8]$ gedit cn8client.c
(base) [dr.d01@fedora cn8]$ gcc cn8server.c
...
server :tranfer completed(base) [dr.d01@fedora cn8]$ 
*/
